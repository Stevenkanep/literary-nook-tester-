 ...
 * Optional: preferred genres and membership interest (per project doc Section 1.1).
 *
...
// Genre options — can be moved to a DB table later
// See: Section 2.1 Book Catalog > Genre support
$genre_options = [
    "Fiction", "Non-Fiction", "Fantasy", "Mystery & Thriller",
    "Romance", "Science Fiction", "Biography", "Self-Help",
    "Children's", "Young Adult", "History", "Horror"
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['register'])) {
    ...
    $preferred_genres = $_POST['genres'] ?? []; // multi-select checkboxes
    ...
    <div class="register-card">
        ...
        <form method="POST" action="register.php">
            ...
            <!-- ------------------------------------------------
                 ...
                 Preferred genres checkbox grid.
                 See: Section 1.1 > "preferred genres" additional field
                 ------------------------------------------------ -->
            <p class="form-section-title">Preferences <span style="font-weight:400; font-size:11px; color: var(--color-text-light);">(Optional)</span></p>

            <div class="form-group">
                <label class="form-label">Preferred Genres</label>
                <p class="form-hint" style="margin-bottom: 12px;">We'll use this to personalize your recommendations.</p>
                    ...
                    <?php foreach ($genre_options as $genre): ?>
                        <label class="genre-option">
                            <input
                                ...
                                <?php echo in_array($genre, (array)($_POST['genres'] ?? [])) ? 'checked' : ''; ?>
                            >
